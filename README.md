...
- Overlays: waymarked hiking trails, slope steepness from NVE (with or without avalanche runout zones), hillshade, a coordinate grid, and a crosshair with live elevation and slope readout
